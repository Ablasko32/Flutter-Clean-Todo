...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( ThemeInitialState value)?  initial,TResult Function( ThemeChanged value)?  changed,required TResult orElse(),}){
final _that = this;
switch (_that) {
case ThemeInitialState() when initial != null:
return initial(_that);case ThemeChanged() when changed != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( ThemeInitialState value)  initial,required TResult Function( ThemeChanged value)  changed,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( ThemeInitialState value)?  initial,TResult? Function( ThemeChanged value)?  changed,}){
final _that = this;
switch (_that) {
case ThemeInitialState() when initial != null:
return initial(_that);case ThemeChanged() when changed != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( bool isDark)?  changed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ThemeInitialState() when initial != null:
return initial();case ThemeChanged() when changed != null:
return changed(_that.isDark);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( bool isDark)  changed,}) {final _that = this;
switch (_that) {
case ThemeInitialState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( bool isDark)?  changed,}) {final _that = this;
switch (_that) {
case ThemeInitialState() when initial != null:
return initial();case ThemeChanged() when changed != null:
return changed(_that.isDark);case _:
...
@override
String toString() {
  return 'ThemeState.changed(isDark: $isDark)';
}
